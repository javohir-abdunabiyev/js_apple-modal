...
const apple_modal = document.querySelector('.apple_modal')
const dialog_modal = document.querySelector('dialog')
...
const an_text = document.querySelector('.animated_text')
const txt_btn = document.querySelector('.btn_flex')



txt_btn.onclick = () => {
    an_text.classList.toggle('ds_block_txt')
}

const an_btn = document.querySelector('.btn_w_flex')
const an_w_txt = document.querySelector('.animated_text_w')

an_btn.onclick = () => {
    an_w_txt.classList.toggle('an_txt_db')
}